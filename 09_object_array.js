...
let yesBank = {  //object inside properties
    bankName: "YesBank",
...
const arrayOfBanks = [sbiBank, axisBank, hdfcBank, yesBank ];//array inside object
...
for (const element of arrayOfBanks)//arrayBanks is the array name and element value we aslo define
 {
    console.log(`${element.bankName}, ${element.location}, ${element.account}, ${element.interestRate}`);
}
